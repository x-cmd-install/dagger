...
[![x-cmd/install — dagger Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/dagger.svg?lang=zh)](https://x-cmd.com/install/dagger)
...
合计: **1,687,506** 行代码（覆盖前 5 种语言、共 **7791** 个文件）。

| 语言 | 代码 | 注释 | 空行 | 文件数 |
|------|-----:|-----:|-----:|------:|
| Go | 1,114,444 | 153,493 | 191,043 | 3429 |
| Json | 305,963 | 0 | 11 | 2712 |
| Python | 40,654 | 995 | 6,187 | 761 |
| TypeScript | 32,261 | 10,821 | 6,687 | 850 |
...
- **上游仓库**: <https://github.com/dagger/dagger>
- **官网**: <https://dagger.io>
- **许可证**: Apache-2.0
...
- **Star**: 16,294 · **Fork**: 929 · **开放 issue**: 3,748 · **贡献者**: 305

## 累计统计

- **发布数**: 951 · **已合并 PR**: 7388 · **开放 PR**: 80 · **已关闭 issue**: 3635 · **开放 issue**: 113 · **提交数**: 13806

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-24 | 8 | 172 | 69 | 24 | 32 | 1145 |
| last60d | 2026-07-25 | 16 | 293 | 76 | 50 | 50 | 1724 |
| 90d | 2026-06-25 | 16 | 402 | 77 | 73 | 65 | 2170 |
| last180d | 2026-03-27 | 100 | 750 | 80 | 124 | 106 | 2927 |
| 360d | 2025-09-28 | 100 | 1321 | 80 | 292 | 113 | 3536 |
| last720d | 2024-10-03 | 100 | 2775 | 80 | 885 | 113 | 4882 |
...
dagger 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `dagger` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/dagger.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260923.yml` · 2026-09-23T04:56:23Z._
